...
--------
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            local function PUMY_fake_script() -- Title.LocalScript 
                local script = Instance.new('LocalScript', ColorpickerTitle)
            ...
            local function PUMY_fake_script() -- Title.LocalScript 
                local script = Instance.new('LocalScript', ConfirmBtnTitle)
            ...
            local function PUMY_fake_script() -- Title.LocalScript 
                local script = Instance.new('LocalScript', RainbowToggleTitle)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            local function PUMY_fake_script() -- Title.LocalScript 
                local script = Instance.new('LocalScript', TextboxTitle)
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            local function PUMY_fake_script() -- Title.LocalScript 
                local script = Instance.new('LocalScript', BindTitle)
